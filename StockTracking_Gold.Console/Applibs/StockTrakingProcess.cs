    ...
    internal class StockTrakingProcess
    {
        ...
        public void StartStockCrawler(string market = "TSE", string onTime = "Y", int gap = 2)
        {
            ...
            try
            {
                ...
                var goldList = stockCrawler.Get_GoldenCrossList(market).Where(o => o.Code.Length == 4).Take(2).ToList();
                ...
                **/
                List<StockViewModelDto> dtoList2 = new List<StockViewModelDto>();
                foreach (var item in stockInfos)
                {
                    dtoList2.Add(new StockViewModelDto
                    {
                        黃金交叉Dto = new 黃金交叉Dto
                        {
                            Date = item.Gold.Date,
                ...
                Console.Write(JsonConvert.SerializeObject(dtoList2, Formatting.Indented));
                // 關閉瀏覽器
